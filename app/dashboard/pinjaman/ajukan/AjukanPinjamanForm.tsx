      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div>
          ...
          <div style={{ position: 'relative' }}>
            <span style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: '#64748b', fontSize: '14px', fontWeight: '600' }}>
              Rp
            </span>
            <input
              type="text"
              ...
              placeholder="0"
              className="fintech-input fintech-input-prefix"
              required
            />
            {/* Hidden input untuk nilai integer sesuai logika asli */}
