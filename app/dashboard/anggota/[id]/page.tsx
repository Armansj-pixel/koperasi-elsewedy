    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .kop-shell { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; background: #f1f5f9; min-height: 100vh; }
        ...
        @media (min-width: 768px) {
          ...
          .kop-grid-responsive { 
            ...
            gap: 24px; 
            align-items: start; /* Mencegah card stretch mengikuti sebelah yang lebih panjang */
          }
        }
      `}} />

      <main className="kop-shell">
        {/* max-w-5xl akan membuat layout membesar di PC tapi tetap terpusat dan rapi */}
        <div className="w-full max-w-5xl mx-auto bg-slate-100 min-h-screen relative sm:shadow-xl sm:border-x sm:border-slate-200">
          ...
          <div className="kop-content-wrapper">
            ...
            {/* Pada layar kecil, ini bertumpuk 1 kolom. Pada tablet/PC, ini jadi 2 kolom */}
            <div className="kop-grid-responsive">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div className="kop-card" style={{ padding: "20px", margin: 0 }}>
                  <SectionTitle icon={<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>} title="Data Pribadi" />
                  <div>
                ...
                {/* --- Data Rekening Bank --- */}
                <div className="kop-card" style={{ padding: "20px", margin: 0 }}>
                  <SectionTitle icon={<line x1="3" y1="22" x2="21" y2="22"/><line x1="6" y1="18" x2="6" y2="11"/><line x1="10" y1="18" x2="10" y2="11"/><line x1="14" y1="18" x2="14" y2="11"/><line x1="18" y1="18" x2="18" y2="11"/><polygon points="12 2 20 7 4 7"/>} title="Data Rekening Bank" />
                  <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {/* --- Data Koperasi --- */}
                <div className="kop-card" style={{ padding: "20px", margin: 0 }}>
                  <SectionTitle icon={<rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><line x1="9" y1="22" x2="9" y2="2"/><line x1="15" y1="22" x2="15" y2="2"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="7" x2="20" y2="7"/><line x1="4" y1="17" x2="20" y2="17"/>} title="Data Koperasi" />
                  <div>
                    <DataRow
                      label="Role Akun"
                ...
                {isSuperAdmin && (
                  <div className="kop-card" style={{ padding: "20px", margin: 0 }}>
                    <SectionTitle icon={<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/>} title="Aksi Administrator" />
